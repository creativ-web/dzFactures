 ...
 * stocks
 * @ORM\Table("pis")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\PisRepository")
 */
class Pis
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="pis", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="pis",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="pis",cascade={"persist"})
