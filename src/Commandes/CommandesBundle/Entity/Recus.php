 ...
 * stocks
 * @ORM\Table("recus")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\RecusRepository")
 */
class Recus
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="recus")
    ...
    /**
     * @ORM\OneToMany(targetEntity="SuiviFacts", mappedBy="recus", cascade={"all"})
     */
    private $SuiviFacts;


    /**
     * @ORM\OneToMany(targetEntity="Aprofact", mappedBy="recus", cascade={"all"})
     */
    private $aprofact;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Lignes", inversedBy="recus", cascade={"all"} )
     */
