 ...
 * stocks
 * @ORM\Table("bts")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BtsRepository")
 */
class Bts
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="bts", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="bts",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="bts",cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Aprodoc", mappedBy="bts", cascade={"all"})
     */
    private $aprodoc;
     ...
     * Set transfert
     *
     * @param \Commandes\CommandesBundle\Entity\Zonnestocks $transfert
     *
     * @return Bts
     */
    public function setTransfert(\Commandes\CommandesBundle\Entity\Zonnestocks $transfert = null)
    {
