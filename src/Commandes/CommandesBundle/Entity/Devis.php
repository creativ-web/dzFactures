 ...
 * stocks
 * @ORM\Table("devis")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\DevisRepository")
 */
class Devis
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="SuiviFacts", mappedBy="devis", cascade={"all"})
     */
    private $SuiviFacts;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Lignes", inversedBy="devis", cascade={"all"} )
     */
