 ...
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\ReservationsRepository")
 */
class Reservations
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="reservations",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="reservations",cascade={"persist"})
