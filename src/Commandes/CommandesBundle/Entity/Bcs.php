 ...
 * stocks
 * @ORM\Table("bcs")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BcsRepository")
 */
class Bcs
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="bcs", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="bcs",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="bcs",cascade={"persist"})
