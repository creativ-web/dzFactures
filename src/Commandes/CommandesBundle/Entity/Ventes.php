 ...
 *
 * @ORM\Table("ventes")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\VentesRepository")
 */
class Ventes
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="ventes")
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
     */
    private $user;

    /**
     * @ORM\ManyToOne(targetEntity="Produits", inversedBy="ventes", cascade={"persist"} )
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Factures", inversedBy="ventes", cascade={"all"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bls", inversedBy="ventes", cascade={"all"})
