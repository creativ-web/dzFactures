...
/**
 * stocks
 * @ORM\Table("bonscommandes")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BonscommandesRepository")
 */
class Bonscommandes
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="bonscommandes")
    ...
    /**
     * @ORM\OneToMany(targetEntity="SuiviFacts", mappedBy="bonscommandes", cascade={"all"})
     */
    private $SuiviFacts;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Lignes", inversedBy="bonscommandes", cascade={"all"} )
     */
    private $lignes;
    /**
     * @var string
