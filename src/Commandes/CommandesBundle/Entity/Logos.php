 ...
 *
 * @ORM\Table("logos")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\LogosRepository")
...
class Logos
{
     ...
     * @var string
     *
     * @ORM\Column(name="alt", type="string", length=125, nullable=true)
     */
    private $alt;
    /**
     *
