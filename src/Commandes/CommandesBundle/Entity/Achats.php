 ...
 *
 * @ORM\Table("achats")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\AchatsRepository")
 */
class Achats
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Produits", inversedBy="achats", cascade={"persist"} )
     ...
     * @var float
     *
     * @ORM\Column(name="puHT", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $puHT;
     ...
     * @var float
     *
     * @ORM\Column(name="puHTreduit", type="decimal",precision=9, scale=2, nullable=true, options={"default" : 0})
     */
    private $puHTreduit;
     ...
     * @var float
     *
     * @ORM\Column(name="puTTC", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $puTTC;
     ...
     * @var float
     *
     * @ORM\Column(name="puTTCreduit", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $puTTCreduit;
     ...
     * @var float
     *
     * @ORM\Column(name="prixHT", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $prixHT;
     ...
     * @var float
     *
     * @ORM\Column(name="prixTTCvente", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
     ...
     * @var float
     *
     * @ORM\Column(name="totalHT", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $totalHT;
     ...
     * @var float
     *
     * @ORM\Column(name="totalTTC", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $totalTTC;
     ...
     * @var float
     *
     * @ORM\Column(name="totalHTa", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $totalHTa;
     ...
     * @var float
     *
     * @ORM\Column(name="totalTTCa", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $totalTTCa;
     ...
     * @var float
     *
     * @ORM\Column(name="prixTTC", type="decimal",precision=10, scale=2, nullable=true, options={"default" : 0})
     */
    private $prixTTC;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bes", inversedBy="achats", cascade={"all"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Depenses", inversedBy="achats", cascade={"all"})
     * @ORM\JoinColumn(name="dep_id", referencedColumnName="id", onDelete="SET NULL")
     */
