 ...
 * stocks
 * @ORM\Table("bes")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BesRepository")
 */
class Bes
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="bes", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="bes",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\OneToMany(targetEntity="Aprodoc", mappedBy="bes", cascade={"all"}, orphanRemoval=true)
     */
    private $aprodoc;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="bes",cascade={"persist"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="Achats", mappedBy="bes", cascade={"all"}, orphanRemoval=true)
     */
    private $achats;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Depenses", inversedBy="bes", cascade={"all"})
