...
/**
 * stocks
 * @ORM\Table("inventaires")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\InventairesRepository")
 */
class Inventaires
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="inventaires",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="inventaires",cascade={"persist"})
