 ...
 * stocks
 * @ORM\Table("becs")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BecsRepository")
 */
class Becs
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="becs",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="becs",cascade={"persist"})
