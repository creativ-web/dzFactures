 ...
 * stocks
 * @ORM\Table("blcs")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\BlcsRepository")
 */
class Blcs
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="blcs", cascade={"persist"})
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
     */
    private $user;
    /**
     * @ORM\ManyToOne(targetEntity="Acheteurs", inversedBy="blcs",cascade={"persist"})
     * @ORM\JoinColumn(name="acheteurs_id", referencedColumnName="id")
     */
    private $acheteur;

    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\Departements", inversedBy="blcs",cascade={"persist"})
