 ...
 *
 * @ORM\Table("commandes")
 * @ORM\Entity(repositoryClass="Commandes\CommandesBundle\Repository\CommandesRepository")
 */
class Commandes
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Commandes\CommandesBundle\Entity\User", inversedBy="commandes")
