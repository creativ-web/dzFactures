...
use Commandes\CommandesBundle\Entity\Devis;
...
class DevisController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $form = $this->createForm('Commandes\CommandesBundle\Form\Filtre\FiltreDevisType');
    ...
    public function newAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $user = $this->getUser();
        $nf = $em->getRepository('CommandesBundle:Devis')->idfact($user);
        $devi = new Devis();
        $form = $this->createForm('Commandes\CommandesBundle\Form\DevisType', $devi);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {

            if ($devi->getDepartements()->getId()) {
                ...
                $q = $qb->update('CommandesBundle:Departements', 'u')
                    ...
                    ->set('u.user', '?16')
                    ->where('u.id = ?14')
                    ->setParameter(1, $devi->getDepartements()->getNom())
                    ->setParameter(2, $devi->getDepartements()->getAdresse())
                    ->setParameter(3, $devi->getDepartements()->getNifselect())
                    ->setParameter(4, $devi->getDepartements()->getNif())
                    ->setParameter(5, $devi->getDepartements()->getCodepostal())
                    ->setParameter(6, $devi->getDepartements()->getVille())
                    ->setParameter(7, $devi->getDepartements()->getIban())
                    ->setParameter(8, $devi->getDepartements()->getBanque())
                    ->setParameter(9, $devi->getDepartements()->getBic())
                    ->setParameter(10, $devi->getDepartements()->getEmail())
                    ->setParameter(11, $devi->getDepartements()->getSiteweb())
                    ->setParameter(12, $devi->getDepartements()->getFax())
                    ->setParameter(13, $devi->getDepartements()->getTelephone())
                    ->setParameter(14, $devi->getDepartements()->getId())
                    ->setParameter(15, $devi->getDepartements()->getNrc())
                    ->setParameter(16, $user)
                    ->getQuery();
                $p = $q->execute();

                $devi->setDepartements($devi->getDepartements()->getId());
            }
            if ($devi->getAcheteur()->getId()) {
                ...
                $q = $qb->update('CommandesBundle:Acheteurs', 'u')
                    ...
                    ->set('u.user', '?16')
                    ->where('u.id = ?14')
                    ->setParameter(1, $devi->getAcheteur()->getNom())
                    ->setParameter(2, $devi->getAcheteur()->getAdresse())
                    ->setParameter(3, $devi->getAcheteur()->getNifselect())
                    ->setParameter(4, $devi->getAcheteur()->getNif())
                    ->setParameter(5, $devi->getAcheteur()->getCodepostal())
                    ->setParameter(6, $devi->getAcheteur()->getVille())

                    ->setParameter(10, $devi->getAcheteur()->getEmail())
                    ->setParameter(11, $devi->getAcheteur()->getSiteweb())
                    ->setParameter(12, $devi->getAcheteur()->getFax())
                    ->setParameter(13, $devi->getAcheteur()->getTelephone())
                    ->setParameter(14, $devi->getAcheteur()->getId())
                    ->setParameter(15, $devi->getAcheteur()->getNrc())
                    ->setParameter(16, $user)
                    ->getQuery();
                $p = $q->execute();
                $devi->setAcheteur($devi->getAcheteur()->getId());
            }

            if ($devi->getVentes()) {

                $questionForms = $devi->getVentes();
            ...
            $devi->setType($devi->getType());
            $devi->setNf($devi->getNf());
            $devi->setLieu($devi->getLieu());
            $devi->setAdditionnelle($devi->getAdditionnelle());
            $devi->setDateadd($devi->getDateadd());

            $devi->setDateregle($devi->getDateregle());
            $devi->setUser($user);
            ...
            return $this->redirectToRoute('admin_devis_show', array('id' => $devi->getId()));
    ...
    public function showAction(Devis $devi)
    {
        ...
        $suivi = $em->getRepository('CommandesBundle:SuiviFacts')->findByDevi($devi);
    ...
    public function editAction(Request $request, Devis $devi)
    {
        ...
        $editForm = $this->createForm('Commandes\CommandesBundle\Form\DevisType', $devi);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            if ($devi->getAcheteur()->getId()) {
                ...
                $q = $qb->update('CommandesBundle:Acheteurs', 'u')
                    ...
                    ->setParameter(15, $devi->getAcheteur()->getNrc())
                    ->setParameter(14, $devi->getAcheteur()->getId())
                    ->setParameter(16, $devi->getAcheteur()->getType())
                ...
                if($questionForms){
                    ...
                    foreach ($questionForms as $questionForm)
                    {
                        ...
                        if($product == $name){
                            ...
                            $aprofact->setQte($qte);
                            $aprofact->setZone($devi->getZonnestocks());
            ...
            $em->flush();
            return $this->redirectToRoute('admin_devis_edit', array('id' => $devi->getId()));
        }
        $em = $this->getDoctrine()->getManager();
        $stocks = $em->getRepository('CommandesBundle:Stocks')->findAll();
     ...
     *
     */
    public function deleteAction(Devis $devi)
    {
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $departements  = $em->getRepository('CommandesBundle:Devis')->findLast($user);
        if($departements){
    ...
    public function pdfAction(Devis $devi)
    {
        $em = $this->getDoctrine()->getManager();
        $devis = $em->getRepository('CommandesBundle:Devis')->findByid($devi);
        ...
        $mPDF->WriteHTML($html);
        $mPDF->Output('Facture-'.$devis->getNf().'.pdf','D');
    ...
    public function envoisAction(Request $request, Devis $devi)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            if($editForm->get('document')->getData()){
                $attachment = new \Swift_Attachment($content, 'Facture-'.$devi->getNf(), 'application/pdf');
    ...
    public function showClientAction(Devis $devi)
    {
