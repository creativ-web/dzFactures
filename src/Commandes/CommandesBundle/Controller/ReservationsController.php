...
use Commandes\CommandesBundle\Entity\Reservations;
...
class ReservationsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reservations = $em->getRepository('CommandesBundle:Reservations')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $bl = new Reservations();
        $form = $this->createForm('Commandes\CommandesBundle\Form\ReservationsType', $bl);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_reservations_show', array('id' => $bl->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($reservation);
        $editForm = $this->createForm('Commandes\CommandesBundle\Form\ReservationsType', $reservation);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('admin_reservations_edit', array('id' => $reservation->getId()));
        }
    ...
    private function createDeleteForm(Reservations $reservation)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_reservations_delete', array('id' => $reservation->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
